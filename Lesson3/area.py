...
def test():
    ...
    print 'data[3]["areaLand"]: ', data[3]["areaLand"]
    print 'data[8]["areaLand"]: ', data[8]["areaLand"]
    print 'data[20]["areaLand"]: ', data[20]["areaLand"]
    print 'data[33]["areaLand"]: ', data[33]["areaLand"]
